...
export default class solar_system extends React.Component {
  ...
  rotate() {
    this.setState({
      ...
      angle1: this.state.angle1 + 0.005,
      ...
      angle6: this.state.angle6 + 0.002,
  ...
  render() {
    return (
      <View>
        ...
        <PointLight
          intensity={1}
          style={{ color: "white", transform: [{ translate: [-40, 0, 0] }] }}
        />
        <Model
        ...
        <Model
          ...
          style={{
            transform: [
              {
                translate: [
                  70 * Math.cos(this.state.angle1),
                  0,
                  60 * Math.sin(this.state.angle1),
                ],
              },
              { scale: [0.8, 0.8, 0.8] },
              { rotateY: this.state.rotation },
        ...
        <Model
          ...
          style={{
            transform: [
              {
                translate: [
                  90 * Math.cos(this.state.angle2),
                  0,
                  70 * Math.sin(this.state.angle2),
                ],
              },
              { scale: [1.1, 1.1, 1.1] },
        ...
        <Model
          ...
          style={{
            transform: [
              {
                translate: [
                  110 * Math.cos(this.state.angle3),
                  0,
                  90 * Math.sin(this.state.angle3),
                ],
              },
              { scale: [1.4, 1.4, 1.4] },
              { rotateY: this.state.rotation },
        ...
        <Model
          ...
          style={{
            transform: [
              {
                translate: [
                  130 * Math.cos(this.state.angle4),
                  0,
                  110 * Math.sin(this.state.angle4),
                ],
              },
              { scale: [0.9, 0.9, 0.9] },
              { rotateY: this.state.rotation },
        ...
        <Model
          ...
          style={{
            transform: [
              {
                translate: [
                  150 * Math.cos(this.state.angle5),
                  0,
                  130 * Math.sin(this.state.angle5),
                ],
              },
              { scale: [4.5, 4.5, 4.5] },
              { rotateY: this.state.rotation },
        ...
        <Model
          ...
          style={{
            transform: [
              {
                translate: [
                  170 * Math.cos(this.state.angle6),
                  0,
                  150 * Math.sin(this.state.angle6),
                ],
              },
              { scale: [3.5, 3.5, 3.5] },
              { rotateX: -20 },
        ...
        <Model
          ...
          style={{
            transform: [
              {
                translate: [
                  190 * Math.cos(this.state.angle7),
                  0,
                  170 * Math.sin(this.state.angle7),
                ],
              },
              { scale: [2.5, 2.5, 2.5] },
        ...
        <Model
          ...
          style={{
            transform: [
              {
                translate: [
                  210 * Math.cos(this.state.angle8),
                  0,
                  190 * Math.sin(this.state.angle8),
                ],
              },
              { scale: [2, 2, 2] },
              { rotateY: this.state.rotation },
